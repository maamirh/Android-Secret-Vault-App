...
public final class ActivityAlphaVideoBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAlphaVideoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAlphaVideoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_alpha_video, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAlphaVideoBinding bind(@NonNull View rootView) {
